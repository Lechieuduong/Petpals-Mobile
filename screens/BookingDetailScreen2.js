...
const BookingDetail2Screen = (props) => {
        ...
        <ScrollView contentContainerStyle={{ height: 1150 }}>
            <View style={{ height: 220, width: 330, backgroundColor: "white", alignSelf: "center", top: 100, borderRadius: 10}}>
                ...
                <View style={{ alignSelf: "flex-start", left: 80, top: 20}}>
                    ...
                    <Text style={{color: "#4080FD", left: 5, fontSize: 40}}>3</Text>
                </View>
                ...
                <View style={{ top: -40, left: 20 , backgroundColor: '#B4CFFF', borderRadius: 10, height: 20, width: 300 }}>
                    <Text style={{ color: "#4080FD", textAlign: "center", left: 4, fontSize: 12, top: 2 }}>Đã hủy</Text>
                </View>
                <View style={{ top: -54, left: 25 , backgroundColor: '#4080FD', borderRadius: 10, height: 8, width: 8, }}/>
                <Text style={{ top: -40, left: 25 , color: '#4080FD', borderRadius: 10, height: 50, width: 300, }}>Đã khám. Lịch khám đã được hủy bởi bạn. Để được hỗ trợ vui lòng liên hệ <Text style={{ color: "blue"}}>1900-8888</Text></Text>
            </View>
...
export default BookingDetail2Screen;
