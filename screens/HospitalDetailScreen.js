...
const HospitalDetailSreen = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.mnHnhThngTinChiTitPh}>
      <View style={[styles.thanhIuHngThngTinPh, styles.thngPosition]}>
        <View style={[styles.searchBar, styles.searchIconPosition]}>
          ...
          <Pressable
            style={styles.vector}
            onPress={() => navigation.navigate("MnHnhThngTinPhngKhm")}
          >
            <Image
      ...
      <Pressable
        style={[styles.footerButton, styles.thngPosition]}
        onPress={() => navigation.navigate("MnHnhTKhm")}
      >
        ...
        <View style={[styles.chuynKhoa, styles.chuynLayout]}>
          ...
          <View style={styles.header2}>
            ...
            <Image
              ...
              contentFit="cover"
              source={require("../assets/vector841.png")}
            />
          </View>
...
export default HospitalDetailSreen;
