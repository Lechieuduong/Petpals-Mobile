  ...
  return (
    <View style={styles.bookingstep1screen}>
      ...
      <View style={{ height: 650, width: "100%" }}>
        <ScrollView contentContainerStyle={{ height: 1150 }}>
            <View style={{ height: 100, width: 330, backgroundColor: "white", alignSelf: "center", top: 120, borderRadius: 10}}>
                ...
                />
                <Text style={{textAlign: "center", color: Color.colorGreen, top: -30, fontSize: 20}}>Đã đặt lịch</Text>
                <Text style={{textAlign: "center", top: -25}}>19:00:00 28/03/2024</Text>
            </View>

            <View style={{ height: 170, width: 330, backgroundColor: "white", alignSelf: "center", top: 130, borderRadius: 10}}>
            ...
            <View style={{ height: 160, width: 330, backgroundColor: "white", alignSelf: "center", top: 130, borderRadius: 10}}>
            ...
            <View style={{ height: 120, width: 330, backgroundColor: "white", alignSelf: "center", top: 150, borderRadius: 10}}>
            <View style={{ alignSelf: "flex-start", left: 20, top: 20}}>
      ...
      <View style={{ height: 100, backgroundColor: "white", top: 20 }}>
        ...
        >
          <Text style={{ color: "gray", textAlign: "center", top: 15 }}>
            Về trang chủ
          </Text>
        </TouchableOpacity>
