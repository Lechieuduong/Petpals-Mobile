...
const HospitalListScreen = (props) => {
  ...
  const onPress1 = () => {
    props.navigation.navigate('HospitalDetailSreen');
  };

  return (
    <View style={styles.calendarlistscreen}>
      <View style={styles.header}>
        <Text style={{ color: "white" , textAlign: "center", top: 50, fontSize:  15, fontFamily: FontFamily.robotoBold}}>Danh sách bệnh viện</Text>
        <Image
        ...
        <TextInput style={{ height: 40, width: 300, alignSelf: "center", backgroundColor: "#54090B", top: 30, borderRadius: 20, textAlign: "center", color: "white"}} placeholder="  Tìm theo tên bệnh viện,..." placeholderTextColor={"white"}></TextInput>
        <Image
      ...
      <View style={{ height: 650, width: "100%" }}>
        <ScrollView contentContainerStyle={{paddingBottom: 80}}>
          <View style={{ height: 180, backgroundColor: "white", width: 330, alignSelf: "center", top: 10, borderRadius: 15 }}>
            <View style={{ top: 20, left: 20 }}>
                    ...
                    />
                    <Text style={{ top: -90, textAlign: 'left', left: 100, fontSize: 15 }}>Bệnh viện</Text>
                    <Text style={{ top: -90, textAlign: 'left', left: 100, fontSize: 20, fontFamily: FontFamily.robotoBold }}>Petpals</Text>
                    <Text style={{ top: -90, textAlign: 'left', left: 100, fontSize: 15, color: "gray" }}>96 Định Công, Hà Nội</Text>
